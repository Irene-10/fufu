...
export const I18N = {
  "zh-CN": {
    ...
    settings: {
      ...
      petInteraction: "宠物互动",
      summonPet: "召唤宠物",
      summonPetHelp: "将宠物显示在鼠标附近，包括已隐藏或留在其它屏幕上的宠物。",
      followCursor: "跟随鼠标",
      followCursorHelp: "让宠物跟着鼠标跑，靠近后停下。拖拽、菜单、气泡提醒和专注期间暂停，结束后继续；支持 macOS 与 Windows。",
      testTools: "测试工具",
      language: "语言",
      petAppearance: "宠物形象",
      customPet: "自定义",
  ...
  en: {
    ...
    menu: {
      showDog: "Show Pet",
      hideDog: "Hide Pet",
      summonPet: "Summon Pet to Cursor",
    ...
    settings: {
      ...
      summonPetHelp: "Show the pet near your cursor, even when hidden or on another display.",
      followCursor: "Follow Cursor",
      followCursorHelp: "Run after the cursor and stop nearby. Pauses during dragging, menus, bubbles and Focus, then resumes. Supports macOS and Windows.",
